...
# Get the Azure AI Search endpoint from the environment variable AZURE_SEARCH_ENDPOINT
SEARCH_ENDPOINT = os.getenv("AZURE_SEARCH_ENDPOINT")
# Get the Azure AI Search key from the environment variable AZURE_SEARCH_KEY
SEARCH_KEY = os.getenv("AZURE_SEARCH_KEY")
# Get the Azure AI Search index name from the environment variable AZURE_SEARCH_INDEX_NAME
